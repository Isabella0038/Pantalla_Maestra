...
namespace Pantalla_Maestra {
    ...
    public partial class RegistrosDataSet : global::System.Data.DataSet {
        ...
        public partial class RegistroDataTable : global::System.Data.TypedTableBase<RegistroRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public RegistroRow AddRegistroRow(int Id, string Nombre, string Apellido, string Contraseña, int Telefono) {
...
namespace Pantalla_Maestra.RegistrosDataSetTableAdapters {
    ...
    public partial class RegistroTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Registro] WHERE (([Id] = @Original_Id) AND ([Nombre] = @Origin" +
                "al_Nombre) AND ([Apellido] = @Original_Apellido) AND ([Contraseña] = @Original_C" +
                "ontraseña) AND ([Telefono] = @Original_Telefono))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Registro] ([Id], [Nombre], [Apellido], [Contraseña], [Telefono" +
                "]) VALUES (@Id, @Nombre, @Apellido, @Contraseña, @Telefono);\r\nSELECT Id, Nombre," +
                " Apellido, Contraseña, Telefono FROM Registro WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Registro] SET [Id] = @Id, [Nombre] = @Nombre, [Apellido] = @Apellido, [Contraseña] = @Contraseña, [Telefono] = @Telefono WHERE (([Id] = @Original_Id) AND ([Nombre] = @Original_Nombre) AND ([Apellido] = @Original_Apellido) AND ([Contraseña] = @Original_Contraseña) AND ([Telefono] = @Original_Telefono));
SELECT Id, Nombre, Apellido, Contraseña, Telefono FROM Registro WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Pantalla_Maestra.Properties.Settings.Default.RegistrosConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Nombre, Apellido, Contraseña, Telefono FROM dbo.Registro";
        ...
        public virtual int Fill(RegistrosDataSet.RegistroDataTable dataTable) {
        ...
        public virtual RegistrosDataSet.RegistroDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            RegistrosDataSet.RegistroDataTable dataTable = new RegistrosDataSet.RegistroDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(RegistrosDataSet.RegistroDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Nombre, string Original_Apellido, string Original_Contraseña, int Original_Telefono) {
        ...
        public virtual int Insert(int Id, string Nombre, string Apellido, string Contraseña, int Telefono) {
        ...
        public virtual int Update(int Id, string Nombre, string Apellido, string Contraseña, int Telefono, int Original_Id, string Original_Nombre, string Original_Apellido, string Original_Contraseña, int Original_Telefono) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nombre, string Apellido, string Contraseña, int Telefono, int Original_Id, string Original_Nombre, string Original_Apellido, string Original_Contraseña, int Original_Telefono) {
            return this.Update(Original_Id, Nombre, Apellido, Contraseña, Telefono, Original_Id, Original_Nombre, Original_Apellido, Original_Contraseña, Original_Telefono);
        }
    }
